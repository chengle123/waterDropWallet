<template>
    <el-row class="app">
        <el-row class="header">
            ...
            <el-col :span="18">
                <el-row>
                    <el-button type="text" class="el-icon-menu floatLeft home" v-model="isCollapse" @click="menuLeft" style="color:rgb(207, 207, 207);font-size: 32px;"></el-button>
                    <el-col :xs="13" :sm="13" :md="13">
                        <el-input placeholder="请输入代币token" v-model="searchText" class="input-with-select">
        ...
        <el-row class="content">
            <el-col :span="6" class="left" :class="!isCollapse ? 'collapse' : '' ">
                <el-row class="buttonBox">
                    <el-col :xs="24" :md="12">
                        <el-button type="success" icon="el-icon-plus" round size="mini" @click="addAccount">添加账户</el-button>
                    </el-col>
                    <el-col :xs="24" :md="12">
                        <!--<el-button icon="el-icon-upload2" round @click="importAccount">导入账户</el-button>-->
                        <el-dropdown trigger="click">
                            <el-button icon="el-icon-upload2" round size="mini">
                                导入账户
                            </el-button>
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item>
                                    <a @click="importAccount()">
                                        导入单个秘钥
                                    </a>
                                </el-dropdown-item>
                                <el-dropdown-item>
                                    <a @click="importAccount('json')">
                                        导入 JSON
                                    </a>
                                </el-dropdown-item>
                                <el-dropdown-item>
                                    <a @click="importAccount('text')">
                                        导入 text
                                    </a>
                                </el-dropdown-item>
                            </el-dropdown-menu>
    ...
    methods: {
        ...
        search(key) {
            if(this.searchText){
                ...
                bus.$emit('selectToken', this.searchText);
            }
        },
        exportAccount(key) {
            var _this = this;
